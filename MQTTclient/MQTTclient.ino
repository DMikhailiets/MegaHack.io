...
#define LED 5 // определяем пин светодиода
#define MQTT_client "ESPled1" // произвольное название MQTT клиента, иногда требуется уникальное.
...
const char *mqtt_server = "sandbox.rightech.io"; // адрес сервера MQTT 
const int mqtt_port = 1883; // Порт для подключения к серверу MQTT
const char *mqtt_user = "admin"; // Логин от сервера MQTT
const char *mqtt_pass = "admin"; // Пароль от сервера MQTT
const char *led_topic="test/led2"; // топик для светодиода
